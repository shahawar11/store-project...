    ...
    <div>
      <div className="relative w-full overflow-hidden bg-white ">
        ...
        <div className="wavetopmd hidden lg:block top-0 left-0 w-full overflow-hidden leading-none">
          <svg
            className="relative block w-[calc(157%+1.3px)] h- z-35"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
            preserveAspectRatio="none"
        ...
        {/* wave top sm */}
        <div className="wavetopsm  hidden top-0 left-0 w-full overflow-hidden leading-none">
          <svg
            className="relative block w-[calc(157%+1.3px)] h-96 z-35"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="  ">
          <div className="flex flex-col md:grid md:grid-cols-2 padding items-center justify-between mx-auto pt- space-y-8 ">
